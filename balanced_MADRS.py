...
def load_data():
    ...
    ## reassign dtypes of columns and assign nans
...
for i in range(0,iterations):
    ...
    accuracy_SMOTE, sensitivity_SMOTE, specificity_SMOTE, fpr_SMOTE, tpr_SMOTE, roc_auc_SMOTE, threshold_SMOTE, importances_df_SMOTE = do_predictions(X_train = X_train, X_test = X_test_2, y_train = y_train, y_test = y_test, i = i, params = best_rf_params_real)
...
plt.plot(mean_fpr_SMOTE, mean_tpr_SMOTE, 'black', label = r'$\it{Standard}$' + ' ' + 'SMOTE' + ' = %0.2f' % mean_roc_auc_SMOTE , linestyle="dashed")
...
results = pd.DataFrame({
    "Balanced Accuracy": [mean_r_SMOTE ,mean_accuracy_OL_20, mean_accuracy_OL_50, mean_accuracy_OL_100, mean_accuracy_RL_20, mean_accuracy_RL_50, mean_accuracy_RL_100 ],
    "std accuracy": [sd_acc_stan_SMOTE, sd_accuracy_OL_20, sd_accuracy_OL_50, sd_accuracy_OL_100, sd_accuracy_RL_20, sd_accuracy_RL_50, sd_accuracy_RL_100],
    "AUROC": [mean_roc_auc_SMOTE, mean_roc_auc_OL_20, mean_roc_auc_OL_50, mean_roc_auc_OL_100, mean_roc_auc_RL_20, mean_roc_auc_RL_50, mean_roc_auc_RL_100 ],
    "std AUROC": [std_roc_auc_SMOTE, std_roc_auc_OL_20, std_roc_auc_OL_50, std_roc_auc_OL_100, std_roc_auc_RL_20, std_roc_auc_RL_50, std_roc_auc_RL_100],
    "Sensitivity": [sensitivity_mean_SMOTE, sensitivity_mean_OL_20, sensitivity_mean_OL_50, sensitivity_mean_OL_100, sensitivity_mean_RL_20, sensitivity_mean_RL_50, sensitivity_mean_RL_100],
    "std Sens": [ sensitivity_std_SMOTE, sensitivity_std_OL_20, sensitivity_std_OL_50, sensitivity_std_OL_100, sensitivity_std_RL_20, sensitivity_std_RL_50, sensitivity_std_RL_100],
    "Specificity": [specificity_mean_SMOTE, specificity_mean_OL_20, specificity_mean_OL_50, specificity_mean_OL_100, specificity_mean_RL_20, specificity_mean_RL_50, specificity_mean_RL_100],
    "std spez": [specificity_std_SMOTE, specificity_std_OL_20, specificity_std_OL_50, specificity_std_OL_100, specificity_std_RL_20, specificity_std_RL_50, specificity_std_RL_100 ],
    "p_value_standard": ["H0", p_value_OL_20, p_value_OL_50, p_value_OL_100, p_value_RL_20, p_value_RL_50, p_value_RL_100],
