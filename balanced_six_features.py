...
def load_data():
    ...
    "replace number coded missings + incorrect cell with NaN"
...
# here MADRS is also included since otherwise the imputation is slightly different due to ordering effects
...
plt.xticks(range(len(OL_accuracys)), [".2",".5","1"])
plt.grid(True)
